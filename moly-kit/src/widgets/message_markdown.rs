...
script_mod! {
    ...
    mod.widgets.MessageMarkdown = Markdown {
        ...
        list_item_layout: Layout { padding: Inset { left: 10.0, right: 10, top: 6.0, bottom: 0 } }
        list_item_walk: Walk { margin: 0, height: Fit, width: Fill }
        code_layout: Layout { padding: Inset { top: 10.0, bottom: 10.0 } }
        quote_layout: Layout { padding: Inset { top: 10.0, bottom: 10.0 } }
